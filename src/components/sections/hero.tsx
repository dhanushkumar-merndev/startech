...
export function Hero() {
  ...
  return (
    <section ref={root} className="relative overflow-hidden pb-20 pt-[180px] md:pb-24 md:pt-[224px]">
      <div
        aria-hidden
      ...
      <div className="shell relative">
        <div className="grid items-end gap-8 lg:grid-cols-12">
          <h1
            className="hero-title split-hold d1 relative z-10 text-[clamp(3.1rem,5.7vw,6.5rem)] font-display font-medium lg:col-span-8"
          >
            <span data-cursor="hero">
              software for your <span className="text-brand">business</span>
            </span>
          </h1>

          <div className="hero-cta flex flex-wrap items-center gap-4 lg:col-span-4 lg:justify-end lg:pb-1">
            <Link href="/contact" className="btn btn-primary group !gap-3 !py-2.5 !pl-5 !pr-2.5">
